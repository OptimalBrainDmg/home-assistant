...
intervals = [
    (0xF0590, 0xF0599),  # cloudy → sunny (10 glyphs, consecutive)
    (0xF059D, 0xF059E),  # windy, windy-variant
    (0xF067E, 0xF067F),  # lightning-rainy, snowy-rainy
    (0xF0F2F, 0xF0F2F),  # cloudy-alert (exceptional)
]
...
# use first icon in the set for font-level metrics (no ASCII in MDI font)
face = load_glyph(0xF0590)
