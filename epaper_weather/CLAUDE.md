...
- **Compass** (`COMP_R=90`, `COMP_INNER_R=60`): outer ring + inner ring; 8px cardinal ticks + 4px intercardinal ticks; N/S/E/W/NE/NW/SE/SW labels in Roboto outside ring; wind speed (FiraSans, integer) + "mph" (Roboto) centered in inner circle; filled arrow triangle in the annulus pointing toward `wind_bearing`. "Calm" (FiraSans) shown in inner circle when wind is null. `DIV2_X=710`, `COMP_CX=840` hardcoded independently.
...
- **Text baselines** (center panel, 3 rows): y = 142, 192, 242 (humidity, pressure, condition); temperature is below the icon in the left panel at `COMP_CY + ICON_SIZE/2 + 43`
